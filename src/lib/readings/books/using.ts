...
~ many-doors | a few doors into the same room
...
~ quiet-hour | small, unhurried, and entirely yours
...
~ trail-fork | one door tends to open onto the next
...
~ small-crossing | a small, complete crossing — and then back to your evening
